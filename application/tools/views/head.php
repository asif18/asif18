...
<link rel="icon" type="image/x-icon" href="<?php echo assets_url('tools/img/favicon.ico'); ?>"/>
...
<link rel="stylesheet" href="<?php echo assets_url('tools/css/bootstrap.min.css'); ?>" />
<link rel="stylesheet" href="<?php echo assets_url('tools/css/font-awesome.min.css'); ?>" />
<link rel="stylesheet" href="<?php echo assets_url('tools/css/angular-growl.min.css'); ?>" />
<link rel="stylesheet" href="<?php echo assets_url('tools/css/style.css'); ?>" />
<?php } else { ?>
<link rel="stylesheet" href="<?php echo assets_url('tools/build/style.min.css'); ?>" />
<?php } ?>
...
<meta itemprop="image" content="<?php echo assets_abs_url('tools/img/asif18-logo.png'); ?>">
...
<meta property="og:image" content="<?php echo assets_abs_url('tools/img/asif18-logo.png'); ?>" />
...
<meta name="twitter:image" content="<?php echo assets_abs_url('tools/img/asif18-logo.png'); ?>" />
<meta name="twitter:creator" content="@mohamedasif18" />
<meta property="og:image" content="<?php assets_url('tools/img/asif18-logo.png'); ?>"/>
