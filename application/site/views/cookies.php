	...
	<div>
		...
		<div class="container">
			...
			<div class="row">
				<!-- Content -->
				<div class="col-lg-12">
					<h1>Cookie Policy for <?php echo ucfirst(SITE_NAME); ?></h1>

					<p>This is the Cookie Policy for <?php echo ucfirst(SITE_NAME); ?>, accessible from <?php  echo base_url(); ?></p>
					...
					<ul>
					<li>Email: mohamedasif18@gmail.com</li>
